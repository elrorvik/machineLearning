...
def test_linear_regression(train_file_name,test_file_name,plot):
    training_data = get_data_from_file(train_file_name)
    X = create_X(training_data);
    ...
    test_data = get_data_from_file(test_file_name)
    X = create_X(test_data);
...
train_file_name = "../regression/train_2d_reg_data.csv"
test_file_name = "../regression/test_2d_reg_data.csv"
test_linear_regression(train_file_name,test_file_name,0)

# Running assignment 1.3
print('')
print('Assignemnt 1.3: Data set 1d')
train_file_name = "../regression/train_1d_reg_data.csv"
test_file_name = "../regression/test_1d_reg_data.csv"
test_linear_regression(train_file_name,test_file_name,1)
