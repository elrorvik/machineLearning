...
y_train = y_train*(y_train!=10)	# changing value with 10 back to 0.(Digit '0' was represented by '10'. Coverting back to '0' to have simple calculations)
...
num_iter = 1000	# number of times gradient descent to be return


net = Network([n,l1,l2])

[theta1, theta2, cost] = net.fit(X_train, one_hot_y_train , regconst, num_iter, eta)
